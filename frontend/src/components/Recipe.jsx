...
function Recipe() {
  ...
  return (
    <div key={recipe.recipe_id}>
      <div className="flex flex-col ml-40 mx-40">
        <section>
          <div className=" recipe relative mt-4 bg-white rounded overflow-hidden shadow-md ">
            <img
            ...
            <div className="flex gap-20 flex-col justify-center items-start absolute top-1/4 left-1/5 transform -translate-y-1/2 mr-40 ml-20 mt-20 ">
              <h1 className="gradient2 font-extrabold text-4xl py-2 font-serif mt-40 text-top bg-white text-black px-4 rounded-lg shadow-md border-2 border-gray-900">
                {recipe.recipe_name}
              </h1>
        ...
        <section className="w-full fixed-sec-size flex mb-10 p-16 gradient2">
          <div className="w-1/3 align-center">
            <ol className="grid gap-8">
              <span className="text-5xl pb-4 pl-5 pt-2 w-2/3 rounded-lg shadow-md border-2 border-gray-900 gradient font-medium italic">
                Ingredients
              </span>
