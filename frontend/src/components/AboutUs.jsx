...
function AboutUs() {
  return (
    <div>
      <div className="relative bg-white rounded overflow-hidden shadow-md">
        ...
        <div className="flex flex-col justify-center items-start absolute top-1/4 left-1/5 transform -translate-y-1/2 mr-40 ml-40">
          ...
          <p className="text-m text-gray-700 px-4 py-2 font-serif mt-10">
            ...
            Assumenda quos quasi voluptatealiquam quas laboriosam nulla sapiente.
            Assumenda.
          </p>
          <button className="bg-orange-500 text-white ml-4 px-4 py-2 rounded-lg shadow-md mt-10 hover:bg-green-300">
            Our Story
          </button>
        </div>
      </div>
