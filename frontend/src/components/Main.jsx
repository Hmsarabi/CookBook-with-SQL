...
function Main() {
  return (
    <>
      <section className="flex justify-start items-center hero top-24 right-0 left-0">
        <a href="">
          <h2 className="text-black font-serif  text-5xl  ml-40">
            RECIPE OF THE DAY
          </h2>
        </a>
      </section>
      <main>
              ...
              <div className="bg-white rounded overflow-hidden shadow-md relative">
                <div>
                  <img
                    src={pastaImage}
                    alt="Pasta"
                    className="w-full sm:h-64 cover"
                  />
                  <div className="my-4 px-2">
                    ...
                    <span className="text-xs">
                      ...
                      Tempore sint fugiat id, dolores similique laborum?
                    </span>
                    <br />
              ...
              <div className="bg-white rounded overflow-hidden shadow-md relative">
                <div>
                  ...
                  <div className="my-4 px-2">
                    <a href="/">
                      <span className="font-bold no-underline hover:underline font-serif">
                        Easy Air Fryer Roasted Carrots And Broccoli
                      </span>
                      <br />
                    </a>
                    <span className="text-xs">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Tempore sint id, dolores similique.
                    </span>
                    <br />
                    <span className="fa fa-star checked mt-5"></span>
                    <span className="fa fa-star checked"></span>
                ...
                <div>
                  ...
                  <div className="my-4 px-2">
                    ...
                    <span className="text-xs">
                      ...
                      consectetur adipisicing elit. Tempore sint fugiat id,
                      dolores similique laborum?
                    </span>
                    <br />
                    <span className="fa fa-star checked mt-5"></span>
                    <span className="fa fa-star checked"></span>
        ...
        <div className="relative mt-4 bg-white rounded overflow-hidden shadow-md">
          ...
          <div className="flex flex-col justify-center items-start absolute top-1/4 left-1/5 transform -translate-y-1/2 mr-40 ml-40">
            ...
            <p className="text-m text-gray-700 px-4 py-2 font-serif mt-10">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Asperiores perspiciatis aperiam, aliquam quas laboriosam nulla
              sapiente. Assumenda quos quasi voluptate reprehenderit.{" "}
            </p>
            <button className="btn bg-orange-500 text-white ml-4 px-4 py-2 rounded-lg shadow-md mt-10 hover:bg-green-300">
              Our Story
            </button>
          </div>
        </div>
        ...
        <div className="relative mb-4 bg-white rounded overflow-hidden shadow-md h-100">
          ...
          <div className="flex flex-col justify-center items-start absolute top-1/4 left-1/5 transform -translate-y-1/2 mr-40 ml-40">
            <h1 className="text-4xl text-black px-4 py-2 font-serif mt-40">
              BE THE FIRST ONE TO TASTE OUR RECIPES!
            </h1>
            <p className="text-m text-gray-700 px-4 py-2 font-serif mt-10">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Asperiores perspiciatis aperiam, aliquam quas laboriosam nulla
              sapiente. Assumenda quos quasi voluptate reprehenderit, asperiores
              consequuntur mollitia perferendis ipsum molestias blanditiis porro
              nesciunt pariatur deleniti culpa sed excepturi esse accusantium
              nulla. Facilis temporibus molestiae ab, itaque et impedit porro at
              excepturi quae aliquam!
            </p>
            <button className="btn bg-orange-500 text-white ml-4 px-4 py-2 rounded-lg shadow-md mt-10 hover:bg-green-300">
              Subscribe
            </button>
